...
if(isset($_POST["idn"]) && !empty($_POST["idn"])){
    ...
    if(empty($input_luz)){
        $luz_err = "Por favor ingresa la apikey.";     
    } else{
        $luz = $input_luz;
    }
    ...
    if(empty($input_humedad_t)){
        $humedad_t_err = "Por favor ingresa la apikey.";     
    } else{
    ...
    if(empty($input_humedad_am)){
        $humedad_am_err = "Por favor ingrese el valor.";     
    } else{
    ...
    if(empty($input_nivel_a)){
        $nivel_a_err = "Por favor ingresa el valor.";     
    } else{
   ...
   if(empty($input_Fecha)){
       $Fecha_err = "Por favor ingresa el valor.";     
   } else{
       $Fecha = $input_Fecha;
   }
                                        ...
                                        <select name="tipo_h" id="tipo_h" class="form-control">
                                            <?php
                                                if($tipo_h == 'Lechuga'){
                                                    ...
                                                    echo "
                                                    <option selected value=1>Lechuga</option>
                                                    <option value=2>Chile habanero</option>
                                                    <option value=3>Tomates</option>
                                                    <option value=4>Cebolla</option>
                                                    <option value=5>cilantro</option>
