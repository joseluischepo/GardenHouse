                            ...
                            <div class="card-body card-block" >
                                <form class="form-horizontal"action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row form-group <?php echo (!empty($apellido_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text"required name="apellido" placeholder="Ingrese su primer apellido" value="<?php echo $apellido; ?>" class="form-control"><small class="form-text text-muted">Apellido</small></div>
                                    ...
                                    <div class="row form-group <?php echo (!empty($correo_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <div class="col-12 col-md-9"><input type="email" required name="correo" placeholder="correo@correo.com" value="<?php echo $correo; ?>" class="form-control"><small class="help-block form-text">Por favor Coloca tu correo</small></div>
                                    ...
                                    <div class="row form-group <?php echo (!empty($numero_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" required name="numero" placeholder="9999999" value="<?php echo $numero; ?>" class="form-control"><small class="form-text text-muted">Numero</small></div>
                                    ...
                                    <div class="row form-group <?php echo (!empty($contra_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <div class="col-12 col-md-9"><input type="password" required name="contra" placeholder="Ingrese su contraseña" value="<?php echo $contra; ?>" class="form-control"><small class="help-block form-text">Por favor introduzca una contraseña</small></div>
