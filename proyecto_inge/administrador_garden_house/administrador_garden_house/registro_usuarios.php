                                    ...
                                    <form class="form-horizontal form-material" action="guardar_usuarios.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12">Contraseña</label>
                                                <div class="col-md-12">
                                                <input type="text" required name="contraseña1" placeholder="Contraseña..." value="" class="form-control form-control-line" />
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-12">Repita la contraseña</label>
                                                <div class="col-md-12">
                                                <input type="text" required name="contraseña2" placeholder="Confirme contraseña..." value="" class="form-control form-control-line" />
                                            </div>
                                        </div>
