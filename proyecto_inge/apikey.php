...
if(isset($_POST["idus"]) && !empty($_POST["idus"])){
    ...
    if(empty($apikey_err)){
        ...
        $sql = "UPDATE usuarios SET apikey=?  WHERE idus=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "si",$param_apikey,$param_idus);
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">apikey</strong>
                                    </div>
                                    <div class="card-body">
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                            <div class="alert alert-danger" role="alert">
                                                ...
                                                <p><a href="usuarios.php" class="btn btn-secondary">Volver</a></p>
                                            </div>
                                        </form>   
                                    </div>
                                </div>
