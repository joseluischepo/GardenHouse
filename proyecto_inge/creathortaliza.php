                    ...
                    <div class="col-lg-12">
                        <div class="card" >
                            <div class="card-header">
                                <strong>HORTALIZAS</strong> creacion
                            </div>
                            <div class="card-body card-block" >
                                <form class="form-horizontal"action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                    <div class="row form-group <?php echo (!empty($titulo_err)) ? 'has-error' : ''; ?>">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Hortaliza</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="titulo" id="titulo" placeholder="Text" class="form-control" value="<?php echo $titulo; ?>"><small class="form-text text-muted">Nombre</small></div>
                                        <span class="help-block"><?php echo $titulo_err;?></span>
                                    </div>       
                                    <div class="row form-group <?php echo (!empty($foto_err)) ? 'has-error' : ''; ?>">
                                        <div class="col col-md-3"><label for="file-input" class=" form-control-label">File input</label></div>
                                        <div class="col-12 col-md-9"><input type="file" name="foto" class="form-control-file"></div>
                                    </div>
