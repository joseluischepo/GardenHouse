            ...
            <div class="animated fadeIn">
                ...
                <div class="orders">
                    <div class="page-header clearfix">
                        ...
                        <a href="creathortaliza.php" class="btn btn-success pull-right">Agregar Hortaliza</a><br></br>
                                                                            ...
                                                                            echo"<table class='table '>";
                                                                                ...
                                                                                echo"<tbody>";
                                                                                    while($row = mysqli_fetch_array($result)){
                                                                                        ...
                                                                                        echo "<td><img width='500px' height='80px' src='". $row['foto'] ."'></td>";                                              
                                                                                            echo "<td>";
                                                                                                echo "<a href='readhortaliza.php?id=". $row['id'] ."' title='Ver' data-toggle='tooltip'><i class='fa fa-eye'></i></a>";
                                                                                                echo "<a href='deletehortaliza.php?id=". $row['id'] ."' title='Borrar' data-toggle='tooltip'><i class='fa fa-trash-o'></i></a>";
                                                                                            echo "</td>";
                                                                                        echo "</tr>";
                                                                                    }
                                                                                echo "</tbody>";                            
