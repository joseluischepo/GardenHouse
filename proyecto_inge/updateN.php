...
$sql = "UPDATE nodo SET luz=?, humedad_t=?, humedad_am=?, nivel_a=? WHERE apikey=$apikey";
...
if($result){
    ...
    //proyecto_inge/api/carga.php?luz=1&humedad_t=1&humedad_am=1&nivel_a=1&tipo_h=Lechuga&idu=1&apikey=OLLBCAGONPPNAHL
        ...
        //proyecto_inge/updateN.php?luz=1&humedad_t=1&humedad_am=1&nivel_a=1&apikey=OLLBCAGONPPNAHL
