                    ...
                    <div class="col-lg-12">
                        <div class="card" >
                            <div class="card-header">
                                <strong>Grafica</strong> Humedad Ambiental y de la tierra
                            </div>
                                        ...
                                        <script>
                                            ...
                                            //const mostrar = (articulos) =>{
                                                ...
                                                //articulos.forEach(element => {
                                                    ...
                                                    myChart.data['datasets'][0].data.push(element.temp_a)
                                                    myChart.data['datasets'][1].data.push(element.nivel_a)
