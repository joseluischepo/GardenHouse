                ...
                <ul class="nav navbar-nav">
                    ...
                    if($_SESSION['tipo'] == 1){   
                        ...
                        <li class='menu-item-has-children dropdown'>
                            ...
                            <ul class='sub-menu children dropdown-menu'>
                            <li><i class='ti-shine'></i><a href='GHAMT.php'>Humedad Ambienta Y tierral</a></li>
                            <li><i class='fa fa-tachometer'></i><a href='GNT.php'>Grafica Nivel y Temperatura Agua</a></li>              
                            </ul>
                        </li>";
                    }
                    ?>
                    ...
                    <div class="col-lg-12">
                        <div class="card" >
                            <div class="card-header">
                                <strong>Grafica</strong> Humedad de la tierra
                            </div>
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <canvas id="myChart" style="position: relative; height: 40vh; width: 80vw;"></canvas>
                                        ...
                                        <script>
                                            ...
                                            let urlhumam = 'http://localhost/garden_house/proyectofinal/Admi_cliente/admin/admin/models/apirest_php/articulos.php'
                                            fetch(urlhumam)
