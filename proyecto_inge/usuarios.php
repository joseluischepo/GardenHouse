...
<head>
    ...
    <link rel="apple-touch-icon" href=""> <!-- necesito cambiar esto y poner nuestro logo-->
            ...
            <div class="animated fadeIn">
                ...
                <div class="orders">
                    <div class="page-header clearfix">
                        ...
                        <a href="createUsuario.php" class="btn btn-success pull-right">Agregar Usuario</a><br></br>
                                                            ...
                                                            echo"<table class='table '>";
                                                                ...
                                                                while($row = mysqli_fetch_array($result)){
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td>";
                                                                            echo "<a href='readUser.php?idus=". $row['idus'] ."' title='Ver' data-toggle='tooltip'><i class='fa fa-eye'></i></a>";
                                                                            echo "<a href='updateUser.php?idus=". $row['idus'] ."' title='Actualizar' data-toggle='tooltip'><i class='fa fa-pencil'></i></a>";
                                                                            echo "<a href='deleteUser.php?idus=". $row['idus'] ."' title='Borrar' data-toggle='tooltip'><i class='fa fa-trash-o'></i></a>";
                                                                            //echo "<a href='apikey.php?idus=". $row['idus'] ."' title='Apikey' data-toggle='tooltip'><i class='fa fa-key'></i></a>";
                                                                        echo "</td>";
                                                                    echo "</tr>";
                                                                }
                                                                echo "</tbody>";                            
                                                                        ...
                                                                        echo"<table class='table '>";
                                                                            ...
                                                                            while($row = mysqli_fetch_array($result)){
                                                                                echo "<tr>";
                                                                                    ...
                                                                                    echo "<td>";
                                                                                    echo "<a href='readUser.php?idus=". $row['idus'] ."' title='Ver' data-toggle='tooltip'><i class='fa fa-eye'></i></a>";
                                                                                    echo "<a href='updateUser.php?idus=". $row['idus'] ."' title='Ver' data-toggle='tooltip'><i class='fa fa-eye'></i></a>";
                                                                                    echo "<a href='deleteUser.php?idus=". $row['idus'] ."' title='Borrar' data-toggle='tooltip'><i class='fa fa-minus-circle'></i></a>";
                                                                                    //echo "<a href='apikey.php?idus=". $row['idus'] ."' title='Apikey' data-toggle='tooltip'><i class='fa fa-key'></i></a>";
                                                                                    echo "</td>";
                                                                                echo "</tr>";
                                                                            }
