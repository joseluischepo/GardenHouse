                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="form-control-static"><?php echo $row["temp_a"]; ?></p>
                                        </div>
                                        <div class="form-group">
                                            <label>Humedad de la tierra</label>
                                            <p class="form-control-static"><?php echo $row["humedad_t"]; ?></p>
                                        </div>
                                        <div class="form-group">
                                            <label>Humedad Ambiental</label>
                                            <p class="form-control-static"><?php echo $row["humedad_am"]; ?></p>
                                        </div>
                                        <div class="form-group">
                                            <label>Nivel Agua</label>
                                            <p class="form-control-static"><?php echo $row["nivel_a"]; ?></p>
                                        </div>
                                        <div class="form-group">
                                            <label>Fecha</label>
                                        ...
                                        <div class="form-group">
                                            <label>Tipo</label>
                                            <p class="form-control-static"><?php echo $row["tipo_h"]; ?></p>
                                        </div>
